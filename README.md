...
LSDB-store should have utility as a standalone service for projects which require a storage engine with property-graph semantics with support for indexing and transactions but not the features of a full-blown graph DBMS.
